...
// Cette class a été généré via la console : php bin/console make:entity

// puis une fois tout crée faire : php bin/console doctrine:schema:update --force
// lui va analyser ce dossier et va comparer pour ne pas mettre ce qui est deja ici encore 1 fois
/**
...
class Serie
{
    ...
    /**
     * @Assert\Range(min="0", max="10", notInRangeMessage="You are not in range select 0-10")
